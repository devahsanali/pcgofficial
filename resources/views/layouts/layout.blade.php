   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="#" class="waves-effect">
          <i class="icon-layers"></i> <span>Tournament</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="sidebar-submenu">
          <li><a href="{{route('admin.tournament.add')}}"><i class="fa fa-circle-o"></i> Create</a></li>
          <li><a href="{{route('admin.tournament.manage')}}"><i class="fa fa-circle-o"></i> Manage</a></li>
        </ul>
      </li>
    </ul>
...
<header class="topbar-nav">
 <nav class="navbar navbar-expand fixed-top bg-white">
  <ul class="navbar-nav mr-auto align-items-center">
    ...
    <li class="nav-item">
      <div class="search-bar">
        <input type="text" id="search" onkeypress="findbykey(event)" required="required" class="form-control" placeholder="Enter keyword">
